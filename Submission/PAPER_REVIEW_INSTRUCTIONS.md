...
Remember this things are liked by reviewer for writing-
You can not use a paper specific term or number before, it was explained or referenced.
Use easy english, human reviewer should understand easily
Avoid long complicated sentences or complicated english word.
Use only few numbers in texts. Use them mainly in tables or figures. Too much number , percentage in text confuse human brain.
What a image or tables explain that should be clearly understandable from text
Image and table should not convey same meaning then what is the point of giving two .
All columns of tables should be consistent and meaningful with captions. Captions should be in one or two lines.
